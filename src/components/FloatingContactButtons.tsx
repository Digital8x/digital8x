...
export default function FloatingContactButtons() {
  return (
    <>
      {/* Levitating Keyframes & Custom Animation CSS */}
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .animate-levitate-whatsapp {
          animation: float-levitate 4s ease-in-out infinite;
        }
        .animate-levitate-phone {
          animation: float-levitate 4s ease-in-out infinite;
          animation-delay: 0.8s; /* Off-phase delay for organic floating motion */
        }
      `}} />
